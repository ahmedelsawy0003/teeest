...
except ModuleNotFoundError:  # pragma: no cover - يعتمد على بيئة التشغيل
    SessionMiddleware = None
    logging.getLogger("promanage").warning(
        "لم يتم تثبيت تبعية itsdangerous، سيتم تعطيل جلسات الكوكيز."
    )
